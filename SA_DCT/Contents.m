% Anisotropic Nonparametric Image Restoration DemoBox (for Matlab 7.5 or later)
% Version 1.22, July 6th 2023 (compatibility fix of v 1.20 of 9 May 2016)
...
%   function_stdEst                     - Estimates noise standard deviation (AWGN).
%   function_ErrorDiffusion             - Generates Error-diffusion Halftones (e.g. Floyd-Steinberg, Jarvis).

% Copyright Tampere University of Technology, Tampere, Finland
% 
