...
if estimate_sigma==1
    for colorchannel=[1 2 3];
        sigma_color(colorchannel)=function_stdEst(zLumChrom(:,:,colorchannel))/l2normLumChrom(colorchannel);   %%% estimates standard deviation from image (assumes perfect AWGN model)
    end
